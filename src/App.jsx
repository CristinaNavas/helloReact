...
function App() {
  ...
  return (
    <>
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia officiis, magnam itaque tenetur dolores nam officia alias velit dicta temporibus quos consequuntur reprehenderit tempore repellat eos explicabo facilis delectus sapiente.</p>
      <div className="card">
